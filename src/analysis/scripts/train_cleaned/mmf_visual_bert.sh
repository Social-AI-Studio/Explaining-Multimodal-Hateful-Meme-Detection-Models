#!/bin/bash
nohup mmf_run dataset=hateful_memes \
        model=visual_bert \
        config=projects/hateful_memes/configs/visual_bert/direct.yaml \
        env.save_dir=./models_clean/visual_bert \
        ...
        dataset_config.hateful_memes.annotations.test[0]=hateful_memes/defaults/annotations/cleaned_test_seen.jsonl > visual_bert_clean.log &